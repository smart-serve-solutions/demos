...
(function (w) {
  ...
  var MODULES = [
    ...
    { id: "seguridad", t: "Seguridad y Auditoría", ic: "shield" },
    ...
    seguridad: [
      {
        ...
        items: [
          {
            t: "Roles, permisos y perfiles de usuario",
            reqs: ["SEG-001", "SEG-002", "SEG-003", "SEG-006"],
            screen: "usuarios",
          },
          {
            t: "Autoservicio de administración de usuarios",
            reqs: ["SEG-008"],
          },
        ],
      },
      {
        ...
        items: [
          {
            t: "Bitácora de auditoría e inactivación de registros",
      ...
      },
      {
        ...
        items: [
          {
            t: "Autorización jerárquica de excepciones",
            reqs: ["SEG-005"],
          },
        ],
      },
        ...
        items: [
          {
            ...
            screen: "bodega",
            tabs: [
              { t: "Pendientes de bodega", id: "", kw: "bandeja pendientes hoy recibir despachar atender" },
            ],
          },
          {
            t: "Existencias",
            d: "Por local, kardex, apartados, contra pedido y segunda",
            reqs: ["INV-003", "INV-004", "INV-005", "INV-009", "INV-010", "INV-020"],
            screen: "existencias",
            tabs: [
              { t: "Por local", id: "local", kw: "existencia disponible matriz local bodega cedi quiebre minimo" },
              { t: "Kardex", id: "kardex", kw: "movimientos entradas salidas saldo corrido" },
              { t: "Apartados y contra pedido", id: "comprometido", kw: "apartado reservado comprometido venta sin existencia contra pedido negativo despachar" },
              { t: "Segunda y devoluciones", id: "segunda", kw: "producto de segunda dañado rayado devolucion proveedor bodega de devoluciones" },
            ],
          },
          {
            t: "Traslados",
            ...
            screen: "traslados",
            tabs: [
              { t: "Sugerido del CEDI", id: "sugerido", kw: "traslado sugerido reabastecer tiendas cedi camion peso" },
              { t: "En camino", id: "camino", kw: "recibir traslado transito diferencias faltante escanear" },
              { t: "Historial", id: "historial", kw: "traslados anteriores chofer vehiculo" },
            ],
          },
          {
            t: "Conteos y ajustes",
            ...
            screen: "ajustes",
            tabs: [
              { t: "Conteo de hoy", id: "conteo", kw: "conteo ciclico inventario fisico contar a ciegas pasillo" },
              { t: "Ajustes y mermas", id: "ajustes", kw: "merma ajuste quebrado dañado vencido foto evidencia aprobacion" },
              { t: "Plan del año", id: "plan", kw: "plan conteo 50 semanas familias prioritarias" },
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            reqs: ["INV-001", "INV-002", "INV-011", "INV-014", "INV-015", "INV-016", "INV-017", "INV-018", "INV-019", "INV-022"],
            screen: "catalogo",
            tabs: [
              { t: "Artículos", id: "articulos", kw: "producto servicio ficha nuevo articulo copiar clonar presentaciones unidades decimales cabys peso ultimo costo" },
              { t: "Precios", id: "precios", kw: "precio costo nuevo cambio masivo margen aprobar" },
              { t: "Códigos y etiquetas", id: "codigos", kw: "codigo de barras etiqueta estante ubicacion foto imprimir" },
              { t: "Carga masiva", id: "carga", kw: "importar plantilla excel migracion" },
            ],
          },
          {
            t: "Reposición",
            ...
            screen: "reposicion",
            tabs: [
              { t: "Sugerido de compra", id: "sugerido", kw: "sugerido pedido compra orden proveedor dias de inventario cedi" },
              { t: "Ventas atípicas", id: "atipicas", kw: "licitacion proyecto venta grande excluir" },
              { t: "Temporadas", id: "temporadas", kw: "estacionalidad lluvias zafra cafe verano clases" },
            ],
          },
        ],
      },
    ...
    fel: [
      {
        ...
        items: [
          ...
          { t: "Comprobantes emitidos", reqs: ["FEL-006"], screen: "fel-emitidos" },
          { t: "Cola de envío y errores de Hacienda", reqs: ["FEL-007"], screen: "fel-cola" },
          { t: "Consecutivos y clave numérica", reqs: ["FEL-008"], screen: "fel-consecutivos" },
        ],
      },
      {
        t: "Recepción y cobro",
        ic: "swap",
        items: [
          { t: "Comprobantes recibidos y mensaje de receptor", reqs: ["FEL-003"], screen: "fel-recibidos" },
          { t: "Recibo electrónico de pago e IVA diferido", reqs: ["FEL-009"], screen: "fel-rep" },
        ],
      },
      {
        ...
        ic: "alert",
        items: [
          { t: "Contingencia ante caída de Hacienda", reqs: ["FEL-004"], screen: "fel-contingencia" },
      ...
      },
      {
        ...
        ic: "scale",
        items: [
          { t: "CABYS, tarifas y exoneraciones", reqs: ["FEL-010"], screen: "fel-cabys" },
          { t: "IVA del período y declaración D-150", reqs: ["FEL-011"], screen: "fel-iva" },
          { t: "Actividades económicas y configuración", reqs: ["FEL-005"], screen: "fel-config" },
        ],
      },
    ],
    bi: [
        ...
        items: [
          {
            ...
            screen: "contabilidad",
            tabs: [
              { t: "Bandeja del contador", id: "", kw: "pendientes revisar aprobar sugerencias excepciones panel contable whatsapp gastos por confirmar" },
            ],
          },
          {
            t: "Conciliaciones",
            ...
            screen: "con-conciliaciones",
            tabs: [
              { t: "Banco", id: "banco", kw: "conciliación bancaria banco nacional movimientos estado de cuenta transferencias" },
              { t: "Caja y medios de pago", id: "caja", kw: "cierre de caja depósitos datáfono tarjetas sinpe faltantes sobrantes" },
              { t: "Inventario", id: "inventario", kw: "kardex costo promedio ajustes de costo merma venta sin existencia" },
              { t: "Cartera y proveedores", id: "cartera", kw: "cuentas por cobrar por pagar auxiliar antigüedad incobrables estimación" },
            ],
          },
          {
            ...
            screen: "con-libros",
            tabs: [
              { t: "Saldos y movimientos", id: "saldos", kw: "balance de comprobación libro mayor saldo corrido cuenta" },
              { t: "Asientos", id: "asientos", kw: "libro diario partidas glosa origen regla asiento manual exportar neo" },
              { t: "Activos fijos", id: "activos", kw: "depreciación reglamento vida útil tasas registrar activo" },
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            screen: "con-informes",
            tabs: [
              { t: "Estados financieros", id: "estados", kw: "estado de resultados situación financiera balance general flujo de efectivo niif" },
              { t: "Por local y familia", id: "local", kw: "centros de costo tiendas sucursales margen por familia" },
              { t: "Presupuesto", id: "presupuesto", kw: "ejecución presupuestaria planeado real desvío" },
            ],
          },
          {
            t: "Cierre",
            ...
            screen: "con-cierre",
            tabs: [
              { t: "Lista de cierre", id: "lista", kw: "cerrar mes aprobación final aprobar enviar gerencia devolver" },
              { t: "Impuestos", id: "impuestos", kw: "iva 150 retenciones 138 renta pagos parciales patentes municipales tribu-cr calendario tributario borrador" },
              { t: "Períodos", id: "periodos", kw: "reabrir bloqueo meses cerrados" },
            ],
          },
          {
            t: "Reglas",
            ...
            screen: "con-reglas",
            tabs: [
              { t: "Catálogo de cuentas", id: "catalogo", kw: "plan contable cuentas niveles nueva cuenta niif marco" },
              { t: "Cuentas por familia y proveedor", id: "cuentas", kw: "configuración contable por ítem artículo proveedor gasto cuenta de destino" },
              { t: "Reglas de conciliación", id: "conciliacion", kw: "reglas aprendidas cruce automático tolerancia" },
              { t: "Asientos automáticos", id: "asientos", kw: "asiento automático documento política exportación neo convivencia" },
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            screen: "nomina",
            tabs: [
              { t: "Resumen y pendientes", id: "resumen", kw: "alertas qué falta atención" },
              { t: "Reportes de nómina", id: "reportes", kw: "costo rotación ausentismo indicadores por local por área" },
            ],
          },
          {
            t: "Planilla",
            ...
            screen: "nom-planilla",
            tabs: [
              { t: "Novedades del periodo", id: "novedades", kw: "comisiones adelantos embargos rebajos deducciones préstamos compras de personal preplanilla" },
              { t: "Cálculo de la planilla", id: "calculo", kw: "corrida colilla recalcular" },
              { t: "Aprobación de la corrida", id: "aprobacion", kw: "resumen patronal cargas firma gerencia" },
              { t: "Pago y archivo del banco", id: "pago", kw: "archivo plano banco nacional colillas depósitos sinpe transferencias" },
              { t: "Asiento y provisiones", id: "asiento", kw: "contabilidad contabilizar pasivo laboral" },
              { t: "Periodos de planilla", id: "periodos", kw: "semanal quincenal mensual historial abrir periodo" },
            ],
          },
          {
            t: "Personal",
            ...
            screen: "nom-personal",
            tabs: [
              { t: "Colaboradores", id: "colab", kw: "expediente ficha cédula ingreso contratación dependientes" },
              { t: "Movimientos de personal", id: "mov", kw: "ingresos salidas aumentos traslados ccss" },
              { t: "Puestos y salarios", id: "puestos", kw: "estructura salarial salario mínimo decreto categorías bandas" },
              { t: "Salidas y liquidaciones", id: "salidas", kw: "liquidación finiquito preaviso cesantía despido renuncia fcl" },
            ],
          },
          {
            ...
            screen: "nom-tiempo",
            tabs: [
              { t: "Asistencia", id: "asist", kw: "marcas reloj tardías ausencias jornadas" },
              { t: "Horas extra y feriados", id: "extras", kw: "recargo tope jornadas de ley" },
              { t: "Vacaciones", id: "vac", kw: "saldos solicitud disfrute" },
              { t: "Incapacidades y permisos", id: "incap", kw: "boleta ccss ins maternidad licencias subsidio" },
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            tabs: [
              { t: "Calendario y terceros", id: "cal", kw: "plazos entidades pensión alimentaria embargo solidarista orden de rebajos ins" },
              { t: "CCSS · SICERE", id: "ccss", kw: "cuotas obrero patronal planilla de la ccss" },
              { t: "Impuesto al salario", id: "renta", kw: "renta tramos tribu-cr f-138 d-103 crédito hijos cónyuge retención" },
          ...
          },
          {
            ...
            screen: "nom-config",
            tabs: [
              { t: "Tasas y tramos", id: "tasas", kw: "cuotas ivm sem salarios mínimos vigencia" },
              { t: "Conceptos", id: "conceptos", kw: "códigos de ingreso y deducción" },
              { t: "Políticas", id: "politicas", kw: "esquemas semanal quincenal mensual integraciones salario escolar adelantos" },
            ],
          },
        ],
      },
  ...
  var SCREENS = {
    ...
    traslados: { t: "Traslados", ic: "route", g: "Catálogo", d: "Sugerido del CEDI, recibido con escáner y diferencias" },
    ajustes: { t: "Conteos y ajustes", ic: "check", g: "Catálogo", d: "Conteo del día, mermas con foto y plan del año" },
    reposicion: { t: "Reposición", ic: "sparkle", g: "Catálogo", d: "Sugerido de compra, ventas atípicas y temporadas" },
    subasta: {
    ...
    contabilidad: { t: "Bandeja del contador", ic: "check", g: "Contabilidad", d: "Lo que el sistema no pudo resolver solo" },
    "con-conciliaciones": { t: "Conciliaciones", ic: "swap", g: "Contabilidad", d: "Banco, cajas, inventario y cartera contra su cuenta" },
    "con-libros": { t: "Libros", ic: "book", g: "Contabilidad", d: "Saldos, movimientos, asientos y activos fijos" },
    "con-informes": { t: "Informes", ic: "chart", g: "Contabilidad", d: "Estados financieros, por local y familia, presupuesto" },
    "con-cierre": { t: "Cierre", ic: "lock", g: "Contabilidad", d: "Lista de cierre, aprobación final e impuestos" },
    "con-reglas": { t: "Reglas contables", ic: "gear", g: "Contabilidad", d: "Cuentas y reglas que hacen que todo corra solo" },
    nomina: { t: "Panel de nómina", ic: "users", g: "Nómina", d: "Lo pendiente, las planillas en curso y los reportes" },
    "nom-planilla": { t: "Planilla", ic: "wallet", g: "Nómina", d: "Novedades, cálculo, aprobación, pago y asiento" },
    "nom-personal": { t: "Personal", ic: "badge", g: "Nómina", d: "Expedientes, movimientos, puestos y salidas" },
    "nom-tiempo": { t: "Tiempo y ausencias", ic: "clock", g: "Nómina", d: "Asistencia, horas extra, vacaciones e incapacidades" },
    "nom-obligaciones": { t: "Obligaciones de ley", ic: "shield", g: "Nómina", d: "CCSS, impuesto al salario, terceros y aguinaldo" },
    "nom-config": { t: "Configuración de nómina", ic: "gear", g: "Nómina", d: "Tasas, tramos, conceptos y políticas" },
    whatsapp: {
    ...
    usuarios: {
      ...
      ic: "lock",
      g: "Sistema",
      d: "Roles, permisos y reglas de sesión",
    },
    historial: {
  ...
  w.NAV = { MODULES: MODULES, MENU_TREE: MENU_TREE, SCREENS: SCREENS, menuFlatten, menuReqCount, menuCount, menuPathFor };
})(window);
